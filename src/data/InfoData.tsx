...
export const InfoData = {
  heading: "About Us",
  paragraphOne:
    "We are a CFA-certified cattery. All of our breeding cats are registered. Cats are a big part of our family," +
  ...
  paragraphTwo:
    "Our belief is that cats are “our children” and they need the best possible care from us. " +
...
export const OwningInfoDataTwo = {
  ...
  paragraphOne:
    "Every kitten will receive 3 FVRCP shots, 1 Rabies shot, and 1 microchip",
  paragraphTwo:
    "All kittens will be registered in CFA system, and all kittens will be sterilized before leaving",
  buttonLabel: "",
  image: InfoImage3,
  reverse: true,
  delay: 100,
...
export const OwningFeatures1 = {
  ...
  paragraph1: "Apply for Litter I Kittens!",
  button1Text: "See Litter I Photos",
  button1Link: "/kittens/litter-i",
  button2Text: "Apply",
  button2Link: "https://forms.gle/AKg8rUkkn8HtNK6A9",
  customButtonLink: "",
  customButtonText: "",
...
export const OwningFeatures2 = {
  ...
  paragraph1:
    "Client requires to sign a deposit agreement and a final purchase agreement prior to reserve a kitten.",
  paragraph2:
    "Both deposit agreement and final purchase agreement are hosted by Docusign",
  button1Text: "",
  button1Link: "",
