...
const LitterInfo: React.FC<LitterInfoProps> = ({
  image,
  alt,
  litterName,
  to,
      ...
      <Section>
        <Container>
          ...
          <InfoRow>
            <LitterInfo
              image={LitterGCover}
              alt="litter g kitten cover image"
              litterName="Litter G"
              to="/kittens/litter-g"
            />
            <LitterInfo
              image={LitterFCover}
              alt="litter f kitten cover image"
              litterName="Litter F"
              to="/kittens/litter-f"
            />
            <LitterInfo
              image={LitterECover}
              alt="litter e kitten cover image"
              litterName="Litter E"
              to="/kittens/litter-e"
            />
            <LitterInfo
              image={LitterDCover}
              alt="litter d kitten cover image"
              litterName="Litter D"
              to="/kittens/litter-d"
            />
            <LitterInfo
              image={LitterCCover}
              alt="litter c kitten cover image"
              litterName="Litter C"
              to="/kittens/litter-c"
            />
            <LitterInfo
              image={LitterBCover}
              alt="litter b kitten cover image"
              litterName="Litter B"
              to="/kittens/litter-b"
            />
            <LitterInfo
              image={LitterACover}
              alt="litter a kitten cover image"
              litterName="Litter A"
              to="/kittens/litter-a"
            />
          </InfoRow>
